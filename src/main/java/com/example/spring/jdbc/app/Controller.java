...
public class Controller {
    ...
    public void getAllGroupWithLessOrEqualStudentsCommand() {
        ...
        logger.info("Finding groups with " + studentNumber +" or less students");
    ...
    public void getStudentByCourseAndName() {
        ...
        logger.info("Getting students with student name: " + studentName +" course: " + courseName);
    ...
    public void createNewStudent() {
        ...
        logger.info("Creating new students with group ID: " + groupId +" first name: " + firstName + " last name: "+ lastName);
    ...
    public void assignStudentToCourse() {
        ...
        logger.info("Assigning student to course student ID: " + studentId + " course ID: " + courseId);
    ...
    public void removeStudentFromCourse() {
        ...
        int courseId = view.requestInt();
        logger.info("Removing student from course - student id: " + studentId + " course ID: " + courseId);
